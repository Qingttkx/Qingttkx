var rule = {
    ...
    // class_name: '绮鹃€�&鐢佃鍓�&鐢靛奖&缁艰壓&鍔ㄦ极&灏戝効&绾綍鐗�',
 ...
 lazy: $js.toString(() => {
    ...
    if (url) {
        ...
        // 澶勭悊娌℃湁鎵惧埌 url 瀛楁鐨勬儏鍐�
        console.error("娌℃湁鎵惧埌浠� 'url' 寮€澶寸殑瀛楁");
    }
    ...
    浜岀骇: $js.toString(() => {
        ...
        try {
            ...
            log("瑙ｆ瀽鐗囧悕娴锋姤绛夊熀纭€淇℃伅鍙戠敓閿欒:" + e.message)
        }
        ...
        let yg = d.filter(function (it) {
            return it.type && it.type !== "姝ｇ墖"
        });
        let zp = d.filter(function (it) {
            return !(it.type && it.type !== "姝ｇ墖")
        });
        VOD.vod_play_from = yg.length < 1 ? "鑵捐瑙嗛" : "鑵捐瑙嗛$$$鑵捐瑙嗛 棰勫憡鍙婅姳绲�";
